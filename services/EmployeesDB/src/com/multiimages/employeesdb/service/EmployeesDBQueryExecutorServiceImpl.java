...
@Service
public class EmployeesDBQueryExecutorServiceImpl implements EmployeesDBQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(EmployeesDBQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("EmployeesDBWMQueryExecutor")
