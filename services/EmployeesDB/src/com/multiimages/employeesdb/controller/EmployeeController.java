...
import com.multiimages.employeesdb.service.EmployeeService;
...
@RestController(value = "EmployeesDB.EmployeeController")
@Api(value = "/EmployeesDB/Employee", description = "Exposes APIs to work with Employee resource.")
@RequestMapping("/EmployeesDB/Employee")
public class EmployeeController {

    private static final Logger LOGGER = LoggerFactory.getLogger(EmployeeController.class);

	@Autowired
	@Qualifier("EmployeesDB.EmployeeService")
    ...
    @ApiOperation(value = "Gets the images instance associated with the given id.")
     public Page<Image> findAssociatedimages(Pageable pageable, @PathVariable("id") Integer id){
        LOGGER.debug("Fetching all associated images");
        return imageService.findAssociatedValues(id,"employee","id", pageable);
   }
